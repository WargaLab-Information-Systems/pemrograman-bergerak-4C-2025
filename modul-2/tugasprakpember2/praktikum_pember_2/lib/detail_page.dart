...
class DetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios_new), // ganti dari arrow_back ke arrow_back_ios_new
          onPressed: () {
              ...
              children: [
                Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Icon(Icons.terrain), // ganti dari map_outlined ke terrain
                    ...
                    Row(
                      children: [
                        const Icon(Icons.place_outlined), // ganti dari location_on_outlined ke place_outlined
                        const SizedBox(width: 3),
                        Text(
                ...
                Row(
                  children: [
                    const Icon(Icons.local_offer_outlined), // ganti dari more_outlined ke price_change
